            ...
            <div class="container-fluid" style="margin-top: 50px">
                ...
                <div class="col-9 ">
                    ...
                    <div class="row gy-2">
                            ...
                            <c:forEach items="${requestScope.waitting_test}" var="s">
                                <div class="col-5 " >
                                    <input type="checkbox" class="del"  name="${requestScope.subject}${s.id}"  hidden>
                                    <a class="p-3 fs-5 border rounded-4 bg-light" href="approve?subject=${requestScope.subject}&test_id=${s.id}"  target="_self" style="display: block;text-decoration: none;color: black">
                                        ${s.test_name}<br>
