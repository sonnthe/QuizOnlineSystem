            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width: 80%" >
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="Linktest?subject=math&page=1">Math<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Linktest?subject=lit&page=1">Literature</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Linktest?subject=eng&page=1">English</a>
                    </li>
                    <c:if test="${sessionScope.user.getRole()==1}" >
                    <li class="nav-item" style="dislay:${sessionScope.user.getRole()==1?'':'none'}">
                        <a class="nav-link" href="alluser">List of users</a>
                    </li>
                    <li class="nav-item" style="dislay:${sessionScope.user.getRole()==1?'':'none'}">
                        <a class="nav-link" href="classlist">List of classes</a>
                    </li>
                    </c:if>
                </ul>
