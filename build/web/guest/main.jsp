...
<!--        <main style="text-align: center" >
            <img src="https://image.luatvietnam.vn/uploaded/twebp/images/original/2023/08/18/khoa-hoc-la-gi-chinh-sach-phat-trien-khoa-hoc-cong-nghe-hien-nay_1808144941.png" class="img-fluid" alt="Responsive image" style="width: 100%">
        </main>-->
        <%
        ...
        <div class="container" style="margin-top: 50px">
            <c:forEach items="<%=subject_list%>" var="s">
                <div class="row p-3 fs-5 border rounded-4 bg-light" >
                    <a  href="login.jsp" style="display: block;text-decoration: none;color: black">${s.sname}<br><br>
