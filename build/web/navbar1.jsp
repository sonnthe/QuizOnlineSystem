...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary" >
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width: 85%">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item ">
                        <a class="nav-link" href="dieu_khoan.jsp">About us<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item     ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: right">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="guest/register.jsp">Register</a>
                    </li>
                </ul> 
            </div>
        </nav>
