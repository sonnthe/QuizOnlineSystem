            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width: 80%" >
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" id="linktest" href="Linktest?subject=math&page=1">Math ${sessionScope.user.getRole()}<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item" style="dislay:${sessionScope.user.getRole()==2?'':'none'}">
