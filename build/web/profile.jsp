            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-4 rounded-4">
                            <div class="card-body text-center">
                                ...
                                <h5 class="my-3">${sessionScope.user.getDisplay_name()}</h5>
                                <p class="text-muted mb-1">${sessionScope.user.getRole()==1?"Admin":"User"}</p>                               
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8 ">
                            ...
                            <div class="card mb-4 rounded-4">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">${sessionScope.user.getDisplay_name()}</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">${sessionScope.user.getPhone_number()}</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">${sessionScope.user.getSchool()}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">                           
                            <c:forEach items="${sessionScope.user.getAccuracy_id()}" var="s">
                            <div class="col-md-4">
