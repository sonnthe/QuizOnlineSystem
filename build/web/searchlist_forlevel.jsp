        ...
        <jsp:include page="navbar2.jsp" ></jsp:include>
            ...
            <div class="container-fluid" style="margin-top: 50px">
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><select name="level" >
                                            <option value="Hard" ${requestScope.level eq "Hard"?'selected':''}>Hard</option>
                                            <option value="Normal" ${requestScope.level eq "Normal"?'selected':''} >Normal</option>
                                            <option value="Easy" ${requestScope.level eq "Easy"?'selected':''}>Easy</option>
                                        </select></td>
                                </tr>
                                <tr>
                    ...
                    or<br>
                    <a class="btn btn-primary mb-2" href="Addtest?subject=${requestScope.subject}" target="_self">Add Test</a>
                        </span>
                </div>
                <div class="col-9 ">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link" href="search?level=${requestScope.level}&page=<%=i%>&levelSubmit=h&subject=${requestScope.subject}"><%=i%></a></li>
                                <%}%>
